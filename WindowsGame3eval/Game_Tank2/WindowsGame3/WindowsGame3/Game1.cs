            ...
            else if (number == 0)
            {
                ...
                if (msg.EndsWith("#"))
                {
                    ...
                    else if (msg.StartsWith("S"))
                    {
                        ...
                        map.UpdatePlayer(contestant[0].playerLocationX + 1, contestant[0].playerLocationY + 1, 50, contestant[0].Direction, false);
                    ...
                    */
                    ...
                    else if (msg.StartsWith("C"))
                    {
                        ...
                        {
                            map.CoinTiles.RemoveAt(map.CoinTiles.Count - 1);
                        }*/
                        CoinPile min;
                        int minX=9, minY=9;
                        ...
                        var endLocation = new Point(coinpile.CoinPileLocationX, coinpile.CoinPileLocationY);
                        ...
                        if (tm != "invalid")
                        {
                            connect(tm);
                            Thread.Sleep(20);
                            map.UpdatePlayer(contestant[0].playerLocationX+1, contestant[0].playerLocationY+1, 50, contestant[0].Direction, true);
                        }
                        ...
                        for (int y = 0; y < 10; y++)
                        {
                            for (int x = 0; x < 10; x++)
                            {
                                if (this.searchParameters.StartLocation.Equals(new Point(x, y)))                                    
                                    ...
                                    Console.Write('C'); // Show the coinpile position
                    ...
                    else if (msg.StartsWith("L"))
                    {
                        ...
                        var startLocation = new Point(contestant[0].playerLocationX, contestant[0].playerLocationY);
                        var endLocation = new Point(lifepack.LifePackLocationX, lifepack.LifePackLocationY);
                        this.searchParameters = new SearchParameters(startLocation, endLocation, AImap);
                        ...
                        //coinpiles.Add(path.Count, coinpile);
                        ...
                        for (int y = 0; y < 10; y++)
                        {
                            for (int x = 0; x < 10; x++)
                            {
                                if (this.searchParameters.StartLocation.Equals(new Point(x, y)))
                                    ...
                                    Console.Write('C'); // Show the lifepack position
                                else if (this.AImap[x, y] == false)
                                    Console.Write('o'); // Show any blocked tiles
                                else if (path.Where(p => p.X == x && p.Y == y).Any())
                                    Console.Write('*'); // Show the path 
